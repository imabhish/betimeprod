(function () {
  ...
  var a = {
      8298: function (a, i, t) {
        ...
        var o = c,
          r = t(2483),
          v = t.p + "img/logo.c0d822b3.png",
          m = t.p + "img/1.9475514e.jpg",
        ...
        const E = [
            ...
            },
            {
              path: "/mine",
              name: "mine",
              component: () => t.e(443).then(t.bind(t, 7175)),
            },
            {
              path: "/privacypolicy",
              name: "privacypolicy",
            ...
            },
            {
              path: "/win",
              name: "win",
              component: () => t.e(443).then(t.bind(t, 6315)),
            },
            {
              path: "/promotion",
              name: "promotion",
              component: () => t.e(443).then(t.bind(t, 9917)),
            },
            {
              path: "/address",
              name: "address",
            ...
            },
            {
              path: "/addbankcard",
              name: "addbankcard",
              component: () => t.e(443).then(t.bind(t, 9689)),
            },
            {
              path: "/withdrawal",
              name: "withdrawal",
            ...
            },
            {
              path: "/rechargerecord",
              name: "rechargerecord",
              component: () => t.e(443).then(t.bind(t, 1174)),
            },
            {
        ...
        if (a[e]) a[e].push(d);
          ...
          if (void 0 !== l)
            for (
              ...
              var v = o[r];
              if (
                v.getAttribute("src") == e ||
                v.getAttribute("data-webpack") == i + l
              ) {
                n = v;
                break;
              }
...
//# sourceMappingURL=app.18a6904f.js.map
