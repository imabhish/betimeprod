    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="wp.png" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">Betime</h6>
                        <span>Admin</span>
                    </div>
                </div>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="wp.png" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">WPCLASSES</span>
                        </a>
            ...
            <br>
                 ...
                 <h2 style="font-size:20px;padding:5px; color:black; text-align:center; color:red; border-style: solid;"onclick="window.location.href='notice'"> Click Here for UPDATE Notice</h2>
                 <h2 style="font-size:20px;padding:5px; color:black; text-align:center; color:red; border-style: solid;"onclick="window.location.href='block'"> Click Here to Block User</h2>
                 <h2 style="font-size:20px;padding:5px; color:black; text-align:center; color:red; border-style: solid;"onclick="window.location.href='unblock'"> Click Here to Unblock User</h2>
                  <h2 style="font-size:20px;padding:5px; color:black; text-align:center; color:red; border-style: solid;"onclick="window.location.href='updateperiod'"> Click Here to UPDATE Period</h2>
                   <h2 style="font-size:20px;padding:5px; color:black; text-align:center; color:red;border-style: solid;"onclick="window.location.href='updateotp'"> Click Here to Update OTP</h2>
                   <h2 style="font-size:20px;padding:5px; color:black; text-align:center; color:red; border-style: solid;"onclick="window.location.href='helpapprove'"> Click Here to Check Quries</h2>
            <!-- Sale & Revenue End -->
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="wpclasses.png">Contact Developer</a> 
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                           
                            Designed By <a href="https://t.me/raj_gaur0001">WP</a>
